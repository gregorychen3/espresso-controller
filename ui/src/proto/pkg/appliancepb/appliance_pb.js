...
goog.exportSymbol('proto.appliancepb.TemperatureStreamRequest', null, global);
goog.exportSymbol('proto.appliancepb.TemperatureStreamResponse', null, global);
goog.exportSymbol('proto.appliancepb.TemperatureStreamResponse.DataCase', null, global);
/**
 ...
 * @constructor
 */
proto.appliancepb.TemperatureStreamRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.appliancepb.TemperatureStreamRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.appliancepb.TemperatureStreamRequest.displayName = 'proto.appliancepb.TemperatureStreamRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.appliancepb.TemperatureStreamResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.appliancepb.TemperatureStreamResponse.oneofGroups_);
};
goog.inherits(proto.appliancepb.TemperatureStreamResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.appliancepb.TemperatureStreamResponse.displayName = 'proto.appliancepb.TemperatureStreamResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.appliancepb.TemperatureStreamRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.appliancepb.TemperatureStreamRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.appliancepb.TemperatureStreamRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.appliancepb.TemperatureStreamRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.appliancepb.TemperatureStreamRequest}
 */
proto.appliancepb.TemperatureStreamRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.appliancepb.TemperatureStreamRequest;
  return proto.appliancepb.TemperatureStreamRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.appliancepb.TemperatureStreamRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.appliancepb.TemperatureStreamRequest}
 */
proto.appliancepb.TemperatureStreamRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.appliancepb.TemperatureStreamRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.appliancepb.TemperatureStreamRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.appliancepb.TemperatureStreamRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.appliancepb.TemperatureStreamRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.appliancepb.TemperatureStreamResponse.oneofGroups_ = [[1,2]];

/**
 * @enum {number}
 */
proto.appliancepb.TemperatureStreamResponse.DataCase = {
  DATA_NOT_SET: 0,
  HISTORY: 1,
  SAMPLE: 2
};
...
/**
 * @return {proto.appliancepb.TemperatureStreamResponse.DataCase}
 */
proto.appliancepb.TemperatureStreamResponse.prototype.getDataCase = function() {
  return /** @type {proto.appliancepb.TemperatureStreamResponse.DataCase} */(jspb.Message.computeOneofCase(this, proto.appliancepb.TemperatureStreamResponse.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.appliancepb.TemperatureStreamResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.appliancepb.TemperatureStreamResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.appliancepb.TemperatureStreamResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.appliancepb.TemperatureStreamResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.appliancepb.TemperatureStreamResponse}
 */
proto.appliancepb.TemperatureStreamResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.appliancepb.TemperatureStreamResponse;
  return proto.appliancepb.TemperatureStreamResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.appliancepb.TemperatureStreamResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.appliancepb.TemperatureStreamResponse}
 */
proto.appliancepb.TemperatureStreamResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.appliancepb.TemperatureStreamResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.appliancepb.TemperatureStreamResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.appliancepb.TemperatureStreamResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.appliancepb.TemperatureStreamResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {?proto.appliancepb.TemperatureHistory}
 */
proto.appliancepb.TemperatureStreamResponse.prototype.getHistory = function() {
 ...
 * @return {!proto.appliancepb.TemperatureStreamResponse} returns this
*/
proto.appliancepb.TemperatureStreamResponse.prototype.setHistory = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.appliancepb.TemperatureStreamResponse.oneofGroups_[0], value);
};
 ...
 * @return {!proto.appliancepb.TemperatureStreamResponse} returns this
 */
proto.appliancepb.TemperatureStreamResponse.prototype.clearHistory = function() {
 ...
 * @return {boolean}
 */
proto.appliancepb.TemperatureStreamResponse.prototype.hasHistory = function() {
 ...
 * @return {?proto.appliancepb.TemperatureSample}
 */
proto.appliancepb.TemperatureStreamResponse.prototype.getSample = function() {
 ...
 * @return {!proto.appliancepb.TemperatureStreamResponse} returns this
*/
proto.appliancepb.TemperatureStreamResponse.prototype.setSample = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.appliancepb.TemperatureStreamResponse.oneofGroups_[0], value);
};
 ...
 * @return {!proto.appliancepb.TemperatureStreamResponse} returns this
 */
proto.appliancepb.TemperatureStreamResponse.prototype.clearSample = function() {
 ...
 * @return {boolean}
 */
proto.appliancepb.TemperatureStreamResponse.prototype.hasSample = function() {
  return jspb.Message.getField(this, 2) != null;
};
